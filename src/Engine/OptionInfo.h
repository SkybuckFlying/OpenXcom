...
private:
	...
	OptionType _type;
	union { bool *b; int *i; std::string *s; ControlKey *k; } _ref;
	union { bool b; int i; const char *s; ControlKey k; } _def; // can't put strings in unions
public:
	...
	OptionInfo(const std::string &id, ControlKey *option, ControlKey def, const std::string &desc = "", const std::string &cat = "");
